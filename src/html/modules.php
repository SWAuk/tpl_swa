...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'swa-nostyle';
  $styles = array(
    'swa-nostyle' => 'modChrome_artnostyle',
    'swa-block' => 'modChrome_artblock',
    'swa-article' => 'modChrome_artarticle',
    'swa-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'swa-...'        - overwrites the default module style.
  //  'suffix swa-...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add swa-... to the module elements.
...
<!-- begin nostyle -->
<div class="swa-nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
