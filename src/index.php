...
<div id="art-main">
	...
	<footer class="art-footer">
		<div class="art-footer-inner">
			...
			<?php else: ?>
				<a title="RSS" class="art-rss-tag-icon" style="position: absolute; bottom: 15px; left: 6px; line-height: 22px;" href="#"></a>
				<div style="position:relative;padding-left:10px;padding-right:10px"><p>Copyright ©
						2013 Student Windsurfing Association. All Rights Reserved.</p></div>
			<?php endif; ?>
		</div>
	</footer>
