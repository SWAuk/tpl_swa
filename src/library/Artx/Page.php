...
class ArtxPage
{
    ...
    public function positions($positions, $style)
    {
        ...
        if (count($cells) == 0)
            return '';
        $result = '<div class="swa-content-layout">';
     ...
     *
     * The componentWrapper method gets the content of the 'component' buffer and searches for the '<div class="swa-post">' string in it.
     * Then it wraps the content of the buffer with the swa-post.
     */
    public function componentWrapper()
    {
        ...
        if (false === strpos($content, '<div class="swa-post'))
        ...
        CKEDITOR.on('instanceReady', function (evt) {
            ...
            if (includesTemplateStyle || includesEditorStyle) {
                ...
                if (includesTemplateStyle)
                    jQuery('body', ifrdoc).attr('id', 'swa-main').addClass('swa-postcontent');
            }
        });
    }
});
