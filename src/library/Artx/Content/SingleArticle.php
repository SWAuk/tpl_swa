...
class ArtxContentSingleArticle extends ArtxContentItem
{
    ...
    public function printIcon()
    {
        ...
        $text = str_replace('<i class="icon-print', '<i class="swa-postprinticon', $text);
        return $text;
    }

    public function toc($toc)
    {
        return '<div class="swa-article">' . $toc . '</div>';
    }

    public function intro($intro)
    {
        return '<div class="swa-article">' . $intro . '</div>';
    }

    public function text($text)
    {
        return '<div class="swa-article">' . $text . '</div>';
    }
